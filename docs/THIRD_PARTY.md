...
| GGZ BREW Tools (`ggzbrewtools-main/`, Tuxality, 2021) | Permissive zlib-style license | Compatible with this GPLv3 project as long as its copyright and license notice remain in adapted source files. Documents the big-endian GGZ entry table and concatenated GZIP member layout used by some BREW/Zeebo games. |
